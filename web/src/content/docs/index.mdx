...
<CardGrid>
  <Card title="Executive Summary" icon="document">
    [Business value, audience, status & roadmap](/gitwhy/docs/executive-summary/)
  </Card>
  <Card title="Architecture Blueprint" icon="seti:graphql">
    [System design, Mermaid diagrams, tech stack rationale](/gitwhy/docs/architecture/)
  </Card>
  <Card title="Self-Review" icon="pen">
    [The five biggest trade-offs, what I'd revisit](/gitwhy/docs/self-review/)
  </Card>
</CardGrid>
